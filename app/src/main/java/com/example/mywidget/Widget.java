...
public class Widget extends AppWidgetProvider {
    ...
    public void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setImageViewResource(R.id.imageView, R.drawable.bat04);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (VERIFICAR.equals(intent.getAction())) {
            ...
            if (level[0] >= 50) {
                ...
                remoteViews.setImageViewResource(R.id.imageView, R.drawable.bat01);
            } else if ((level[0] < 50) && (level[0] >= 15)) {
                remoteViews.setTextColor(R.id.appwidget_text, Color.parseColor("#FFA500"));
                remoteViews.setImageViewResource(R.id.imageView, R.drawable.bat02);
            } else if (level[0] < 15) {
                remoteViews.setTextColor(R.id.appwidget_text, Color.parseColor("#FF0000"));
                remoteViews.setImageViewResource(R.id.imageView, R.drawable.bat03);
            }
